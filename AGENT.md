...
|----------|----------|-------------|
| `SWARM_HUB_URL` | ✅ | WebSocket URL of your Hub worker |
| `TELEGRAM_USER_ID` | Optional | Your Telegram User ID ([@userinfobot](https://t.me/userinfobot)) |
| `TELEGRAM_BOT_URL` | Optional | URL of your Telegram bot worker |
...
Then copy this file to your project root as the appropriate agent rules file.
