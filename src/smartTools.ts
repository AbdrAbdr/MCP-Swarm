...
// HNSW - Fast vector search for semantic memory
import { handleHNSWTool } from "./workflows/hnsw.js";

// AIDefence - Security and threat detection
...
// Docs
import { autoGenerateDocs, listDocs } from "./workflows/autoDocumentation.js";
...
export const allSmartTools = [
  ...
  // 48: v0.9.4 Batching
  swarmBatchTool,
  // 49: v0.9.5 SONA - Self-Optimizing Neural Architecture
  swarmSONATool,
  // 50: v0.9.6 Agent Booster - Fast local execution
  swarmBoosterTool,
  // 51: v0.9.7 HNSW Vector Search
  swarmVectorTool,
  // 52: v0.9.8 AIDefence - Security & Threat Detection
  swarmDefenceTool,
  // 53: v0.9.9 Consensus - Distributed Agreement
  swarmConsensusTool,
  // 54: v0.9.10 MoE Router - Mixture of Experts
  swarmMoETool,
];
