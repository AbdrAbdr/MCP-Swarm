...
# 🐝 MCP Swarm v0.9.16 — Универсальная Платформа Координации AI-Агентов

> ⚠️ **v0.9.16 — Критический фикс:** Предыдущие версии (0.9.14–0.9.15) содержали баг совместимости Zod, который ломал ВСЕ Smart Tools. Обновитесь немедленно: `npm install -g mcp-swarm@latest`
