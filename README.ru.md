...
# 🐝 MCP Swarm v1.1.4 — Универсальная Платформа Координации AI-Агентов

> 🐝 **v1.1.4 — Telegram Bot + Полная документация:** Telegram уведомления о задачах, агентах и ошибках. Web Dashboard на `localhost:37373`. Все **26 Smart Tools** через Remote Bridge. Обновитесь: `npm install -g mcp-swarm@latest`
