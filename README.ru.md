...
# 🐝 MCP Swarm v0.9.17 — Универсальная Платформа Координации AI-Агентов

> ✅ **v0.9.17 — Архитектурное обновление:** Модульная кодовая база, Cloudflare Workers с аутентификацией `SWARM_AUTH_TOKEN`, CI/CD пайплайн, удаление legacy. Обновитесь: `npm install -g mcp-swarm@latest`
