...
> 🐝 **v1.1.5 — Интерактивный Telegram Bot:** Создание задач из чата, AI-распознавание намерений (РУ/EN), push-уведомления от Hub, Mini App дашборд, inline-управление задачами. Все **26 Smart Tools** через Remote Bridge. Обновитесь: `npm install -g mcp-swarm@latest`
